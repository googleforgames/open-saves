...
func (c *openSavesClient) CreateChunkUrls(ctx context.Context, in *CreateChunkUrlsRequest, opts ...grpc.CallOption) (*CreateChunkUrlsResponse, error) {
	out := new(CreateChunkUrlsResponse)
	err := c.cc.Invoke(ctx, "/opensaves.OpenSaves/CreateChunkUrls", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOpenSavesServer) CreateChunkUrls(context.Context, *CreateChunkUrlsRequest) (*CreateChunkUrlsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateChunkUrls not implemented")
}
...
func _OpenSaves_CreateChunkUrls_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateChunkUrlsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OpenSavesServer).CreateChunkUrls(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/opensaves.OpenSaves/CreateChunkUrls",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OpenSavesServer).CreateChunkUrls(ctx, req.(*CreateChunkUrlsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
