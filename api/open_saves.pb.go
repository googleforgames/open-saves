...
var file_open_saves_proto_depIdxs = []int32{
	...
	6,  // 25: opensaves.GetBlobRequest.hint:type_name -> opensaves.Hint
	22, // 26: opensaves.GetBlobResponse.metadata:type_name -> opensaves.BlobMetadata
	6,  // 27: opensaves.GetBlobChunkRequest.hint:type_name -> opensaves.Hint
	26, // 28: opensaves.GetBlobChunkResponse.metadata:type_name -> opensaves.ChunkMetadata
	6,  // 29: opensaves.DeleteBlobRequest.hint:type_name -> opensaves.Hint
	4,  // 30: opensaves.CompareAndSwapRequest.value:type_name -> opensaves.Property
	4,  // 31: opensaves.CompareAndSwapRequest.old_value:type_name -> opensaves.Property
	6,  // 32: opensaves.CompareAndSwapRequest.hint:type_name -> opensaves.Hint
	4,  // 33: opensaves.CompareAndSwapResponse.value:type_name -> opensaves.Property
	6,  // 34: opensaves.AtomicIntRequest.hint:type_name -> opensaves.Hint
	6,  // 35: opensaves.AtomicIncRequest.hint:type_name -> opensaves.Hint
	4,  // 36: opensaves.Record.PropertiesEntry.value:type_name -> opensaves.Property
	8,  // 37: opensaves.OpenSaves.CreateStore:input_type -> opensaves.CreateStoreRequest
	9,  // 38: opensaves.OpenSaves.GetStore:input_type -> opensaves.GetStoreRequest
	10, // 39: opensaves.OpenSaves.ListStores:input_type -> opensaves.ListStoresRequest
	12, // 40: opensaves.OpenSaves.DeleteStore:input_type -> opensaves.DeleteStoreRequest
	13, // 41: opensaves.OpenSaves.CreateRecord:input_type -> opensaves.CreateRecordRequest
	14, // 42: opensaves.OpenSaves.GetRecord:input_type -> opensaves.GetRecordRequest
	15, // 43: opensaves.OpenSaves.QueryRecords:input_type -> opensaves.QueryRecordsRequest
	19, // 44: opensaves.OpenSaves.UpdateRecord:input_type -> opensaves.UpdateRecordRequest
	20, // 45: opensaves.OpenSaves.DeleteRecord:input_type -> opensaves.DeleteRecordRequest
	21, // 46: opensaves.OpenSaves.CreateBlob:input_type -> opensaves.CreateBlobRequest
	23, // 47: opensaves.OpenSaves.CreateChunkedBlob:input_type -> opensaves.CreateChunkedBlobRequest
	25, // 48: opensaves.OpenSaves.UploadChunk:input_type -> opensaves.UploadChunkRequest
	27, // 49: opensaves.OpenSaves.CommitChunkedUpload:input_type -> opensaves.CommitChunkedUploadRequest
	28, // 50: opensaves.OpenSaves.AbortChunkedUpload:input_type -> opensaves.AbortChunkedUploadRequest
	29, // 51: opensaves.OpenSaves.GetBlob:input_type -> opensaves.GetBlobRequest
	31, // 52: opensaves.OpenSaves.GetBlobChunk:input_type -> opensaves.GetBlobChunkRequest
	33, // 53: opensaves.OpenSaves.DeleteBlob:input_type -> opensaves.DeleteBlobRequest
	34, // 54: opensaves.OpenSaves.Ping:input_type -> opensaves.PingRequest
	36, // 55: opensaves.OpenSaves.CompareAndSwap:input_type -> opensaves.CompareAndSwapRequest
	38, // 56: opensaves.OpenSaves.CompareAndSwapGreaterInt:input_type -> opensaves.AtomicIntRequest
	38, // 57: opensaves.OpenSaves.CompareAndSwapLessInt:input_type -> opensaves.AtomicIntRequest
	38, // 58: opensaves.OpenSaves.AtomicAddInt:input_type -> opensaves.AtomicIntRequest
	38, // 59: opensaves.OpenSaves.AtomicSubInt:input_type -> opensaves.AtomicIntRequest
	40, // 60: opensaves.OpenSaves.AtomicInc:input_type -> opensaves.AtomicIncRequest
	40, // 61: opensaves.OpenSaves.AtomicDec:input_type -> opensaves.AtomicIncRequest
	7,  // 62: opensaves.OpenSaves.CreateStore:output_type -> opensaves.Store
	7,  // 63: opensaves.OpenSaves.GetStore:output_type -> opensaves.Store
	11, // 64: opensaves.OpenSaves.ListStores:output_type -> opensaves.ListStoresResponse
	43, // 65: opensaves.OpenSaves.DeleteStore:output_type -> google.protobuf.Empty
	5,  // 66: opensaves.OpenSaves.CreateRecord:output_type -> opensaves.Record
	5,  // 67: opensaves.OpenSaves.GetRecord:output_type -> opensaves.Record
	18, // 68: opensaves.OpenSaves.QueryRecords:output_type -> opensaves.QueryRecordsResponse
	5,  // 69: opensaves.OpenSaves.UpdateRecord:output_type -> opensaves.Record
	43, // 70: opensaves.OpenSaves.DeleteRecord:output_type -> google.protobuf.Empty
	22, // 71: opensaves.OpenSaves.CreateBlob:output_type -> opensaves.BlobMetadata
	24, // 72: opensaves.OpenSaves.CreateChunkedBlob:output_type -> opensaves.CreateChunkedBlobResponse
	26, // 73: opensaves.OpenSaves.UploadChunk:output_type -> opensaves.ChunkMetadata
	22, // 74: opensaves.OpenSaves.CommitChunkedUpload:output_type -> opensaves.BlobMetadata
	43, // 75: opensaves.OpenSaves.AbortChunkedUpload:output_type -> google.protobuf.Empty
	30, // 76: opensaves.OpenSaves.GetBlob:output_type -> opensaves.GetBlobResponse
	32, // 77: opensaves.OpenSaves.GetBlobChunk:output_type -> opensaves.GetBlobChunkResponse
	43, // 78: opensaves.OpenSaves.DeleteBlob:output_type -> google.protobuf.Empty
	35, // 79: opensaves.OpenSaves.Ping:output_type -> opensaves.PingResponse
	37, // 80: opensaves.OpenSaves.CompareAndSwap:output_type -> opensaves.CompareAndSwapResponse
	39, // 81: opensaves.OpenSaves.CompareAndSwapGreaterInt:output_type -> opensaves.AtomicIntResponse
	39, // 82: opensaves.OpenSaves.CompareAndSwapLessInt:output_type -> opensaves.AtomicIntResponse
	39, // 83: opensaves.OpenSaves.AtomicAddInt:output_type -> opensaves.AtomicIntResponse
	39, // 84: opensaves.OpenSaves.AtomicSubInt:output_type -> opensaves.AtomicIntResponse
	39, // 85: opensaves.OpenSaves.AtomicInc:output_type -> opensaves.AtomicIntResponse
	39, // 86: opensaves.OpenSaves.AtomicDec:output_type -> opensaves.AtomicIntResponse
