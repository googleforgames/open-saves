...
>>>>>>> c027f89f8d8a143b97746e6617414dfe16343841
...
func (c *openSavesClient) CreateBlob(ctx context.Context, opts ...grpc.CallOption) (OpenSaves_CreateBlobClient, error) {
	stream, err := c.cc.NewStream(ctx, &_OpenSaves_serviceDesc.Streams[0], "/opensaves.OpenSaves/CreateBlob", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *openSavesClient) GetBlob(ctx context.Context, in *GetBlobRequest, opts ...grpc.CallOption) (OpenSaves_GetBlobClient, error) {
	stream, err := c.cc.NewStream(ctx, &_OpenSaves_serviceDesc.Streams[1], "/opensaves.OpenSaves/GetBlob", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedOpenSavesServer can be embedded to have forward compatible implementations.
...
func RegisterOpenSavesServer(s *grpc.Server, srv OpenSavesServer) {
	s.RegisterService(&_OpenSaves_serviceDesc, srv)
}
...
var _OpenSaves_serviceDesc = grpc.ServiceDesc{
