...
/*
Package triton is a reverse proxy.
...
func request_Triton_CreateStore_0(ctx context.Context, marshaler runtime.Marshaler, client TritonClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Triton_CreateStore_0(ctx context.Context, marshaler runtime.Marshaler, server TritonServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateStoreRequest
	var metadata runtime.ServerMetadata
...
func request_Triton_GetStore_0(ctx context.Context, marshaler runtime.Marshaler, client TritonClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Triton_GetStore_0(ctx context.Context, marshaler runtime.Marshaler, server TritonServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetStoreRequest
	var metadata runtime.ServerMetadata
...
func request_Triton_ListStore_0(ctx context.Context, marshaler runtime.Marshaler, client TritonClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Triton_ListStore_0(ctx context.Context, marshaler runtime.Marshaler, server TritonServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListStoresRequest
	var metadata runtime.ServerMetadata
...
func request_Triton_DeleteStore_0(ctx context.Context, marshaler runtime.Marshaler, client TritonClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Triton_DeleteStore_0(ctx context.Context, marshaler runtime.Marshaler, server TritonServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteStoreRequest
	var metadata runtime.ServerMetadata
...
// RegisterTritonHandlerServer registers the http handlers for service Triton to "mux".
// UnaryRPC     :call TritonServer directly.
...
func RegisterTritonHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TritonServer) error {
	...
	mux.Handle("POST", pattern_Triton_CreateStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Triton_CreateStore_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Triton_CreateStore_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_Triton_GetStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Triton_GetStore_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Triton_GetStore_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_Triton_ListStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Triton_ListStore_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Triton_ListStore_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("DELETE", pattern_Triton_DeleteStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Triton_DeleteStore_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Triton_DeleteStore_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterTritonHandlerFromEndpoint is same as RegisterTritonHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterTritonHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterTritonHandler(ctx, mux, conn)
}

// RegisterTritonHandler registers the http handlers for service Triton to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterTritonHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterTritonHandlerClient(ctx, mux, NewTritonClient(conn))
}

// RegisterTritonHandlerClient registers the http handlers for service Triton
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "TritonClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "TritonClient"
...
func RegisterTritonHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TritonClient) error {
	...
	mux.Handle("POST", pattern_Triton_CreateStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Triton_CreateStore_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Triton_GetStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Triton_GetStore_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Triton_ListStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Triton_ListStore_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_Triton_DeleteStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Triton_DeleteStore_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Triton_CreateStore_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "stores"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Triton_GetStore_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "stores", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Triton_ListStore_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "stores"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	forward_Triton_CreateStore_0 = runtime.ForwardResponseMessage

	forward_Triton_GetStore_0 = runtime.ForwardResponseMessage

	forward_Triton_ListStore_0 = runtime.ForwardResponseMessage
